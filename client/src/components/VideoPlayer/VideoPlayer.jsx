...
const VideoPlayer=()=>{
    ...
    return(
        <Grid container className={classes.gridContainer}>
            ...
            {stream &&( //this checks whether we have our stream
            ...
            <Paper className={classes.paper}>
                <Grid item xs={12} md={6}>
                    ...
                    <video playinline ref={myVideo} autoPlay className={classes.video}/>
                </Grid>
...

            {
                ...
                callAccepted && !callEnded && ( //this checkes whether call is accepted or ended
